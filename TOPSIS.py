...
class topsis:
    ...
    def step2(self):
        ...
        for j in range(self.n):
            ...
            for i in range(self.m):
                self.r[i, j] = self.a[i,j]/nm
        print(pd.DataFrame(self.r))

    # Step 3
    def step3(self):
        self.t = self.r * self.w
        print("nomorlized and weighted matrix: ")
        # print(self.t)
    ...
    def step55(self):
        ...
        df = pd.DataFrame()
        # df1 = pd.read_excel("C:\\Users\\MaTao\\Desktop\\mba\\DMD\\dmd.xlsx", sheetname="Sheet2")
        # df['code'] = df1['code']
        # df['Subject'] = df1['Subject']
        df['year'] = [2004, 2005, 2006, 2007, 2008]
        df['diw'] = diw_list
        df['dib'] = dib_list
        df['siw'] = siw_list
        print(df)
        print(df.sort_values(by='siw', ascending=False))
...
if __name__ == '__main__':
    ...
    sheetname_data = "data3"
    sheetname_weight = "weight3"
